...
{
    /// <summary>
    /// Тестирование базовых классов библиотеки
    /// </summary>
    [TestClass]
    public class BaseTest
    {
        /// Тестирование методов Equals и GetHashCode у точки
        [TestMethod]
        ...
        /// <summary>
        /// Тестирование методов Equals, GetHashCode и логики вычисления длины у стороны фигуры
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Тестирование метода вычисления площади у разных наследников IAreable без знания типа фигуры
        /// </summary>
        [TestMethod]
